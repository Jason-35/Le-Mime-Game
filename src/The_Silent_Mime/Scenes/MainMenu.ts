...
export default class MainMenu extends Scene {
  ...
  public loadScene() {
    this.load.image("logo", "project_assets/menu_image/Mime.png");
    this.load.image("bag", "project_assets/menu_image/help_bag.png");
    this.load.image("wasd", "project_assets/menu_image/controls.png");
  }
