...
export default class Moving_Down extends PlayerState {
  public onEnter(options: Record<string, any>): void {
    this.parent.owner.animation.play(PlayerAnimationType.MOVING_DOWN);
  }
  ...
  public update(deltaT: number): void {
    ...
    if (this.parent.controller.moveDir.equals(Vec2.ZERO)) {
      this.finished(PlayerStateType.IDLE_DOWN);
    }
  }
